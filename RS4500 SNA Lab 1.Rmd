...
*This shows your working directory, it shows all of the files in the folder related to the project. It is just like a file browser for your computer, with come extra R related options.*  
  ...
  *This is a script, it holds the code which makes up the program named "app.R". You can right code in this window, save it and run it. Don't worry to much about the code for now. And it isn't as complicated as it looks, by the end of the semester you most of it will make sense.*  

  + Run the App by clicking "Run App" in the top right of the "app.R" window.  
  ![](data/runApp.png)
  
*The program with install and load all of the packages needed to run the app. You will see this happen in red font in the console.*  
...
* **Add a node and an edge to the excel file.**  
  ...
  ![](data/data.png)
*This is the same data that you saw in the table tab in the App. This App is actually reactive, meaning it is constantly looking for updates in the excel file and then updating the app.*   
